...
public class BuildConfigGenerator {
    ...
    private BuildConfig generateNewBuildConfig(Project project, String name) {
        ...
        ProjectBuildInfo buildInfo = buildInfoDetector.detect(project);
        buildConfig.setBuildType(buildInfo.getBuildType().name());

        Environment selectedEnv = environments.selectEnvironment(buildInfo);
    ...
    private String generateBuildScript(String taintedMessage, String buildCommand) {
        String commentAutogenerated = "# This script was autogenerated";
        return renderBuildScript(taintedMessage, commentAutogenerated, buildCommand);
    }
